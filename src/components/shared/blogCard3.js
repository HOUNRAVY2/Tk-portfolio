...
export default function BlogCard3({ load }) {
  return (
    <div className='  rounded-md hover:scale-[1.02] transition-all'>
      <div className='relative w-full aspect-[8/5] mb-[-13px]'>
        <Image
      ...
      <div className=' pb-[5px] px-[20px] pt-[40px] bg-blog_frame2 bg-no-repeat bg-cover bg-top  rounded-b-md relative'>
